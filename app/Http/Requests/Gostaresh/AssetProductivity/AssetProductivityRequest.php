...
class AssetProductivityRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ratio_of_faculty_members_to_students' => 'required|numeric|gte:0|lte:2147483647',
            'ratio_of_staff_to_students' => 'required|numeric|gte:0|lte:2147483647',
            'ratio_of_faculty_members_to_teaching_professors' => 'required|numeric|gte:0|lte:2147483647',
            'ratio_of_faculty_members_to_employees' => 'required|numeric|gte:0|lte:2147483647',
            'ratio_of_unit_faculty_members_to_faculty_members_of_the_province' => 'required|numeric|gte:0|lte:2147483647',
            'ratio_of_unit_students_to_students_of_the_province' => 'required|numeric|gte:0|lte:2147483647',
            'ratio_of_unit_employees_to_provincial_employees' => 'required|numeric|gte:0|lte:2147483647',
            'unit_teaching_professors_to_teaching_professors_province' => 'required|numeric|gte:0|lte:2147483647',
