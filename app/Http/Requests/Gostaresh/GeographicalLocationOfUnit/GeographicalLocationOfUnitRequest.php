...
class GeographicalLocationOfUnitRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "distance_to_the_nearest_higher_education_center" => 'required|numeric|gte:0|lte:2147483647',
            "distance_to_the_nearest_unit_of_azad_university" => 'required|numeric|gte:0|lte:2147483647',
