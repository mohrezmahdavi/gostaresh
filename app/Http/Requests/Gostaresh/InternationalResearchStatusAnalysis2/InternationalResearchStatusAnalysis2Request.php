...
class InternationalResearchStatusAnalysis2Request extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'unit' => 'required',
            'average_H_index_of_faculty_members' => 'required|numeric|gte:0|lte:2147483647',
            'number_of_articles_science_and_nature' => 'required|numeric|gte:0|lte:2147483647',
            'print_ISI_articles' => 'required|numeric|gte:0|lte:2147483647',
            ...
            'amount_of_international_research_credits' => 'required|numeric|gte:0|lte:2147483647',
            'number_of_international_publications' => 'required|numeric|gte:0|lte:2147483647',
