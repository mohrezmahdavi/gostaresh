...
class OrganizationalCultureRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'percentage_of_sample_professors_in_unit' => 'required|numeric|between:-99.99,99.99',
            'percentage_of_sample_professors_in_province' => 'required|numeric|between:-99.99,99.99',
            'percentage_of_sample_students_in_unit' => 'required|numeric|between:-99.99,99.99',
            'percentage_of_sample_students_in_province' => 'required|numeric|between:-99.99,99.99',
