...
class OrganizationalCultureRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'percentage_of_sample_professors_in_unit' => 'required|numeric|gte:0',
            'percentage_of_sample_professors_in_province' => 'required|numeric|gte:0',
            'percentage_of_sample_students_in_unit' => 'required|numeric|gte:0',
            'percentage_of_sample_students_in_province' => 'required|numeric|gte:0',
