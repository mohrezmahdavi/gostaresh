...
class LineChartByPopulationComponent extends Component
{
    /**
    ...
    public function render()
    {
        ...
        $charts_arr = [];
        $chart_arr = [
            'chart_title' => "نمودار بر حسب جمعیت",
        ...
        return view('components.gostaresh.demographic-changes-of-city.line-chart-by-population-component', compact('chart'));
    }
}
