...
class LineChartByAllFieldsYearComponent extends Component
{
    ...
    {
        $modelQuery = EconomicParticipationRate::whereRequestsQuery();
        ...
        return view('components.gostaresh.economic-participation-rate.line-chart-by-all-fields-year-component', compact('chart'));
    }
}
