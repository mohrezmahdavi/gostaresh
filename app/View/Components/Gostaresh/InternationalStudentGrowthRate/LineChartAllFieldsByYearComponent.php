...
namespace App\View\Components\Gostaresh\InternationalStudentGrowthRate;
...
class LineChartAllFieldsByYearComponent extends Component
{
    ...
    {
        $modelQuery = InternationalStudentGrowthRate::whereRequestsQuery();
        ...
        return view('components.gostaresh.international-student-growth-rate.line-chart-all-fields-by-year-component', compact("chart"));
    }
}
