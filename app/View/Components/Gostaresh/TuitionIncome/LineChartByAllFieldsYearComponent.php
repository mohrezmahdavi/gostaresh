...
class LineChartByAllFieldsYearComponent extends Component
{
    ...
    {        
        $modelQuery = AverageTuitionIncome::whereRequestsQuery();
        ...
        $chart_arr3 = [
            ...
            'chart_type' => 'line',
            'aggregate_function' => 'sum',
            'aggregate_field' => 'professional_phd',
            'aggregate_transform' => function ($value) {
                return $value;
            },
        ];
        ...
        return view('components.gostaresh.tuition-income.line-chart-by-all-fields-year-component', compact('chart'));
    }
}
