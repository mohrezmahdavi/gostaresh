...
class LineChartByAllFieldsYearComponent extends Component
{
    ...
    {
        $modelQuery = UnemploymentRate::whereRequestsQuery();
        ...
        return view('components.gostaresh.unemployment-rate.line-chart-by-all-fields-year-component', compact('chart'));
    }
}
