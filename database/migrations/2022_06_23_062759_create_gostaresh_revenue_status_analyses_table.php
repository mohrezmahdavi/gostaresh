...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('gostaresh_revenue_status_analyses', function (Blueprint $table) {
            ...
            $table->float('total_revenue')->comment('کل درآمد ها')->nullable();
            $table->float('income_from_student_tuition')->comment('درآمد حاصل از شهریه دانشجویان')->nullable();
            ...
            $table->float('income_from_skills_training')->comment('درآمدهای حاصل از مهارت آموزی، فعالیت های کاربنیان و کارآفرینی واحد')->nullable();
            $table->float('operating_income_growth_rate')->comment('نرخ رشد درآمدهای عملیاتی واحد')->nullable();
            $table->float('total_non_tuition_income')->comment('مجموع درآمدهای غیر شهریه ای واحد')->nullable();
            $table->float('total_international_income')->comment('مجموع درآمد های ناشی از فعالیت های بین المللی')->nullable();
