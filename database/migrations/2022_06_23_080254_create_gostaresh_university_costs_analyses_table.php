...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('gostaresh_university_costs_analyses', function (Blueprint $table) {
            ...
            $table->string('average_salaries_of_faculty_members_from_research_contracts')->comment('میانگین حقوق دریافتی اعضای هیات علمی دانشگاه آزاد اسلامی استان از محل قراردهای تحقیقاتی، آموزشی و خدماتی')->nullable();
            ...
            $table->string('extra_charge_for_rent_extracurricular_building')->comment('هزینه پرداخت اجاره ساختمان فوق برنامه')->nullable();
            ...
            $table->string('development_costs')->comment('هزینه های حوزه تحقیق و توسعه')->nullable();
