...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('gostaresh_number_of_admissions_status_analyses', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('number_of_admissions')->nullable();
    ...
    {
        Schema::dropIfExists('gostaresh_number_of_admissions_status_analyses');
    }
};
