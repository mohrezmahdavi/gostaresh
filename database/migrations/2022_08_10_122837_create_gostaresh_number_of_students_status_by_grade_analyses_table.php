...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('gostaresh_number_of_students_status_by_grade_analyses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('gostaresh_number_of_students_status_by_grade_analyses');
    }
};
