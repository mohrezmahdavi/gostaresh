...
@if (filterCol('medical_sciences_count') == true)
    <td>{{ number_format($academicMajorEducational?->medical_sciences_count) }}</td>
@endif
...
@if (filterCol('farhangian_count') == true)
    <td>{{ number_format($academicMajorEducational?->farhangian_count) }}</td>
@endif
...
@if (filterCol('fani_herfei_count') == true)
    <td>{{ number_format($academicMajorEducational?->fani_herfei_count) }}</td>
@endif
