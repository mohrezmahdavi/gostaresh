                ...
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="amount" name="amount" value="{{ $amountOfFacility->amount }}"
                                    class="form-control" placeholder=" میزان را وارد کنید...">
                            </div>
                        </div>

                        <x-select-year :default="$amountOfFacility->year" min="1390" max="1400" :required="false" name="year"></x-select-year>
