            ...
            <div class="card">
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST"
                        action="{{ route('asset-productivity.update', $assetProductivity) }}"
                        role="form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="unit" name="unit"
                                       value="{{ $assetProductivity->unit }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="utilization_rate_of_educational_equipment" name="utilization_rate_of_educational_equipment"
                                       value="{{ $assetProductivity->utilization_rate_of_educational_equipment }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="utilization_rate_of_technology_equipment" name="utilization_rate_of_technology_equipment"
                                       value="{{ $assetProductivity->utilization_rate_of_technology_equipment }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="utilization_rate_of_cultural_equipment" name="utilization_rate_of_cultural_equipment"
                                       value="{{ $assetProductivity->utilization_rate_of_cultural_equipment }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="utilization_rate_of_sports_equipment" name="utilization_rate_of_sports_equipment"
                                       value="{{ $assetProductivity->utilization_rate_of_sports_equipment }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="operation_rate_of_agricultural_equipment" name="operation_rate_of_agricultural_equipment"
                                       value="{{ $assetProductivity->operation_rate_of_agricultural_equipment }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="operation_rate_of_workshop_equipment" name="operation_rate_of_workshop_equipment"
                                       value="{{ $assetProductivity->operation_rate_of_workshop_equipment }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="faculty_capacity_utilization_rate" name="faculty_capacity_utilization_rate"
                                       value="{{ $assetProductivity->faculty_capacity_utilization_rate }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="employee_capacity_utilization_rate" name="employee_capacity_utilization_rate"
                                       value="{{ $assetProductivity->employee_capacity_utilization_rate }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="graduate_capacity_utilization_rate" name="graduate_capacity_utilization_rate"
                                       value="{{ $assetProductivity->graduate_capacity_utilization_rate }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="student_capacity_utilization_rate" name="student_capacity_utilization_rate"
                                       value="{{ $assetProductivity->student_capacity_utilization_rate }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="ratio_of_faculty_members_to_students" name="ratio_of_faculty_members_to_students"
                                       value="{{ $assetProductivity->ratio_of_faculty_members_to_students }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="ratio_of_faculty_members_to_teaching_professors" name="ratio_of_faculty_members_to_teaching_professors"
                                       value="{{ $assetProductivity->ratio_of_faculty_members_to_teaching_professors }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="ratio_of_faculty_members_to_employees" name="ratio_of_faculty_members_to_employees"
                                       value="{{ $assetProductivity->ratio_of_faculty_members_to_employees }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="ratio_of_unit_faculty_members_to_faculty_members_of_the_province" name="ratio_of_unit_faculty_members_to_faculty_members_of_the_province"
                                       value="{{ $assetProductivity->ratio_of_unit_faculty_members_to_faculty_members_of_the_province }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="ratio_of_unit_students_to_students_of_the_province" name="ratio_of_unit_students_to_students_of_the_province"
                                       value="{{ $assetProductivity->ratio_of_unit_students_to_students_of_the_province }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="ratio_of_unit_employees_to_provincial_employees" name="ratio_of_unit_employees_to_provincial_employees"
                                       value="{{ $assetProductivity->ratio_of_unit_employees_to_provincial_employees }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="unit_teaching_professors_to_teaching_professors_province" name="unit_teaching_professors_to_teaching_professors_province"
                                       value="{{ $assetProductivity->unit_teaching_professors_to_teaching_professors_province }}" class="form-control"
                                       placeholder=" نسبت تعداد اساتید مدعو و حق التدریس به میانگین تعداد اساتید مدعو و حق التدریس استان را وارد کنید...">
                            </div>
                        </div>

                        <x-select-year :default="$assetProductivity->year" :required="false" name="year"></x-select-year>
