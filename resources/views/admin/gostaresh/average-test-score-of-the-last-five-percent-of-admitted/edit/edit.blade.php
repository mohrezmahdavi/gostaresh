        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body" id="app">
                    @include('admin.partials.row-notifiy-col')
                    <form class="form-horizontal" method="POST" action="{{ route('average.test.score.of.the.first.thirty.percent.of.admitted.update', $averageTestScoreOfTheLastFivePercentOfAdmitted) }}" role="form">
                        @csrf
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="average_test_score_of_the_first_thirty_percent_of_admitted" name="average_test_score_of_the_first_thirty_percent_of_admitted"
                                    value="{{ $averageTestScoreOfTheLastFivePercentOfAdmitted->average_test_score_of_the_first_thirty_percent_of_admitted }}" class="form-control"
