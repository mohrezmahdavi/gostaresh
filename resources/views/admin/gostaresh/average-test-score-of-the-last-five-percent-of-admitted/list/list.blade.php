...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can("delete-any-AverageTestScoreOfTheLastFivePercentOfAdmitted")
                                            <form method="POST"
                                                  action="{{ route('average.test.score.of.the.last.five.percent.of.admitted.destroy', $averageTestScoreOfTheLastFivePercentOfAdmitted) }}"
                                                  role="form">
                                                @csrf
                                                {{ method_field('delete') }}
    ...
    <div class="row">
        <div class="col-md-12">
            <x-gostaresh.average-test-score-of-the-last-five-percent-of-admitted.line-chart-all-fields-by-year-component/>
        </div>
    </div>
@endsection
