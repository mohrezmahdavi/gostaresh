...
@section('page-title')
    ...
    <span>
        <a href="{{ route('cost-of-majors.index') }}" class="btn btn-secondary btn-sm">بازگشت به لیست اطلاعات</a>
    </span>
@endsection
                ...
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="professional_phd" name="professional_phd" value="{{ $costOfMajor['professional_phd'] }}"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="phd" name="phd" value="{{ $costOfMajor['phd'] }}"
