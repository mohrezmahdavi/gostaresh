...
@section('title-tag')
    ویرایش تحلیل وضعیت شاخص ها و برنامه های فرهنگی
@endsection
...
@section('page-title')
    ...
    <span>
        <a href="{{ route('cultural-indicators.index') }}" class="btn btn-secondary btn-sm">بازگشت به لیست اطلاعات</a>
    </span>
@endsection
            ...
            <div class="card">
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST"
                        action="{{ route('cultural-indicators.update', $culturalIndicator) }}" role="form">
                        @csrf
                        @method('PUT')

                        <select-province-component province_default="{{ $culturalIndicator->province_id ?? ''}}"
                            zone_default="{{ $culturalIndicator->county->zone ?? ''}}"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="cultural_centers_status_score"
                                    name="cultural_centers_status_score"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="printed_publications_status_score"
                                    ...
                                    value="{{ $culturalIndicator->printed_publications_status_score }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="cultural_organizations_status_score"
                                    ...
                                    value="{{ $culturalIndicator->cultural_organizations_status_score }}"
                                    class="form-control" placeholder=" نمره وضعیت تشکلهای فرهنگی واحد را وارد کنید...">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="interact_with_cyberspace_status_score"
                                    ...
                                    value="{{ $culturalIndicator->interact_with_cyberspace_status_score }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="fixed_cultural_events_status_score"
                                    ...
                                    value="{{ $culturalIndicator->fixed_cultural_events_status_score }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="amounts_of_honors_and_awards"
                                    name="amounts_of_honors_and_awards"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="points_for_running_luxury_programs"
                                    ...
                                    value="{{ $culturalIndicator->points_for_running_luxury_programs }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="score_cultural_skills_training_programs"
                                    ...
                                    value="{{ $culturalIndicator->score_cultural_skills_training_programs }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="score_of_cultural_participation_of_Basiji_professors"
                                    ...
                                    value="{{ $culturalIndicator->score_of_cultural_participation_of_Basiji_professors }}"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="participation_of_unit_professors_in_cultural_counseling"
                                    ...
                                    value="{{ $culturalIndicator->participation_of_unit_professors_in_cultural_counseling }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="position_of_the_university_as_cultural_center"
                                    ...
                                    value="{{ $culturalIndicator->position_of_the_university_as_cultural_center }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="score_Families_of_professors"
                                    name="score_Families_of_professors"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="satisfaction_of_managers_performance"
                                    ...
                                    value="{{ $culturalIndicator->satisfaction_of_managers_performance }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="percentage_of_students_participating_in_sports_competitions"
                                    ...
                                    value="{{ $culturalIndicator->percentage_of_students_participating_in_sports_competitions }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="percentage_of_students_participating_in_cultural_competitions"
                                    ...
                                    value="{{ $culturalIndicator->percentage_of_students_participating_in_cultural_competitions }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="percentage_of_students_in_student_organizations"
                                    ...
                                    value="{{ $culturalIndicator->percentage_of_students_in_student_organizations }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="percentage_of_students_referring_to_student_counseling_centers"
                                    ...
                                    value="{{ $culturalIndicator->percentage_of_students_referring_to_student_counseling_centers }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="general_cultural_rank_of_the_university_unit"
                                    ...
                                    value="{{ $culturalIndicator->general_cultural_rank_of_the_university_unit }}"
                                    class="form-control" placeholder=" رتبه کلی فرهنگی واحد دانشگاهی را وارد کنید...">
                            </div>
                        </div>

                        <x-select-year :default="$culturalIndicator->year" min="{{ config('gostaresh.year.min', 1370) }}" max="{{ config('gostaresh.year.max', 1405) }}" :required="false" name="year"></x-select-year>
