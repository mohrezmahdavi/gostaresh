...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <x-gostaresh.economic-participation-rate.pie-chart-education-id-economic-participation-rate-component></x-gostaresh.economic-participation-rate.pie-chart-education-id-economic-participation-rate-component>
        </div>
    </div>
@endsection
