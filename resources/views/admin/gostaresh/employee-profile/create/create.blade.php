...
@section('page-title')
    ...
    <span>
        <a href="{{ route('employee-profile.index') }}" class="btn btn-secondary btn-sm">بازگشت به لیست اطلاعات</a>
    </span>
@endsection
                ...
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST" action="{{ route('employee-profile.store') }}" role="form">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="number_of_administrative_staff"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="number_of_diploma_and_sub_diploma_employees"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="number_of_employees_studying"
