        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST" action="{{ route('growth.rate.student.population.store') }}"
                        role="form">
                        @csrf
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="motevasete_2_ensani" name="motevasete_2_ensani"
                                    value="{{ old('motevasete_2_ensani') }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="motevasete_2_science" name="motevasete_2_science"
                                    value="{{ old('motevasete_2_science') }}" class="form-control"
                                    placeholder="تعداد  را وارد کنید...">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="motevasete_2_kar_danesh" name="motevasete_2_kar_danesh"
                                    value="{{ old('motevasete_2_kar_danesh') }}" class="form-control"
                                    placeholder="تعداد  را وارد کنید...">
                            </div>
                        </div>
