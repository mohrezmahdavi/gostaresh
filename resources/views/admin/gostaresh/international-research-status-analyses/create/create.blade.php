        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST" action="{{ route('international-research.store') }}"
                        role="form">
                        @csrf
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_international_research_projects"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_faculty_members_using_study_abroad"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_graduate_students_with_opportunities_abroad"
                                    name="number_of_graduate_students_with_opportunities_abroad"
                                    value="{{ old('number_of_graduate_students_with_opportunities_abroad') }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_research_opportunities_presented"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_foreign_workshops_held"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_international_lectures_held"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_international_awards"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_faculty_members_of_world_scientists"
                                    ...
                                    value="{{ old('number_of_faculty_members_of_world_scientists') }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_faculty_members_of_international_journals"
                                    ...
                                    value="{{ old('number_of_faculty_members_of_international_journals') }}"
                                    class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_international_agreements_implemented"
                                    ...
                                    value="{{ old('number_of_international_agreements_implemented') }}"
                                    class="form-control"
