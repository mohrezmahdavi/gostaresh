            ...
            <div class="card">
                <div class="card-body" id="app">
                    ...
                    <form class="form-horizontal" method="POST"
                        action="{{ route('international-research.update', $internationalResearch) }}"
                        role="form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="average_H_index_of_faculty_members" name="average_H_index_of_faculty_members"
                                       value="{{ $internationalResearch->average_H_index_of_faculty_members }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="percentage_of_quality_articles" name="percentage_of_quality_articles"
                                       value="{{ $internationalResearch->percentage_of_quality_articles }}" class="form-control"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <select name="year" id="year" class="form-select">
                                    @for ($i = 1250; $i <= 1405; $i++)
                                        <option {{ $i == $internationalResearch->year ? 'selected' : '' }}
                                            value="{{ $i }}">
                                            {{ $i }}</option>
                                    @endfor
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <select name="month" id="month" class="form-select">
                                    @for ($i = 1; $i <= 12; $i++)
                                        <option {{ $i == $internationalResearch->month ? 'selected' : '' }}
                                            value="{{ $i }}">
                                            {{ $i }}</option>
                                    @endfor
