...
@if (filterCol('number_of_research_opportunities_presented') == true)
    <th>تعداد فرصت های تحقیقاتی و پسادکتری ارایه شده به محققان و دانشجویان کشورهای خارجی ومحققان ایرانی خارج از کشور</th>
@endif
@if (filterCol('number_of_foreign_workshops_held') == true)
    <th>تعداد کارگاهها، دوره های آموزشی و تدریس بین المللی برگزار شده توسط اساتید خارجی ومتخصصان ایرانی غیر مقیم</th>
@endif
