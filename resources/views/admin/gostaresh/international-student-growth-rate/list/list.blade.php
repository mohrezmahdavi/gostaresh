...
@can("create-any-InternationalStudentGrowthRate")
    <span>
...
@can("delete-any-InternationalStudentGrowthRate")
 ...
 @endcan
    ...
    <div class="row">
        <div class="col-md-12">
            <x-gostaresh.international-student-growth-rate.line-chart-all-fields-by-year-component />
        </div>
    </div>
@endsection
