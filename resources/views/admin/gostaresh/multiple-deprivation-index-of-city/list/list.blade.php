...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @can('delete-any-MultipleDeprivationIndexOfCity')
                                                <form method="POST"
                                                    action="{{ route('multiple.deprivation.index.of.city.destroy', $multipleDeprivationIndexOfCity) }}"
                                                    role="form">
                                                    @csrf
                                                    {{ method_field('delete') }}
    ...
    <div class="row">
        <div class="col-md-6">
            <x-gostaresh.multiple-deprivation-index-of-city.line-chart-by-all-fields-year-component></x-gostaresh.multiple-deprivation-index-of-city.line-chart-by-all-fields-year-component>
        </div>
    </div>
@endsection
