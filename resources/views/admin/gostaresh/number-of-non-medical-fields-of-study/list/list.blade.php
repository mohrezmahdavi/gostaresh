...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can("delete-any-NumberOfNonMedicalFieldsOfStudy")
                                            <form method="POST"
                                                  action="{{ route('number.of.non.medical.fields.of.study.destroy', $numberOfNonMedicalFieldsOfStudy) }}"
                                                  role="form">
                                                @csrf
                                                {{ method_field('delete') }}
    ...
    <div class="row">
        <div class="col-md-12">
            <x-gostaresh.number-of-non-medical-fields-of-study.line-chart-all-fields-by-year-component/>
        </div>
    </div>
@endsection
