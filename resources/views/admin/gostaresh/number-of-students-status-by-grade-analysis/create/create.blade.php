...
@section('title-tag')
ایجاد تحلیل وضعیت تعداد دانشجویان بر اساس مقطع
@endsection
...
ایجاد تحلیل وضعیت تعداد دانشجویان بر اساس مقطع
    ...
    <span>
        <a href="{{ route('number.of.students.status.by-grade.analysis.index') }}" class="btn btn-secondary btn-sm">بازگشت به لیست اطلاعات</a>
    </span>
@endsection
            ...
            <div class="card">
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST"
                        action="{{ route('number.of.students.status.by-grade.analysis.store') }}" role="form">
                        @csrf
