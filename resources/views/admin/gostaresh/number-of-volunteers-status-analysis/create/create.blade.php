...
@section('title-tag')
ایجاد تحلیل وضعیت تعداد داوطلبان
@endsection
...
ایجاد تحلیل وضعیت تعداد داوطلبان
    ...
    <span>
        <a href="{{ route('number.of.volunteers.status.analysis.index') }}" class="btn btn-secondary btn-sm">بازگشت به لیست اطلاعات</a>
    </span>
@endsection
            ...
            <div class="card">
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST"
                        action="{{ route('number.of.volunteers.status.analysis.store') }}" role="form">
                        @csrf
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="number_of_volunteers" name="number_of_volunteers"
