                ...
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST" action="{{ route('number.student.population.update', $numberStudentPopulation) }}" role="form">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" style="direction: rtl" id="ebtedai" name="ebtedai" value="{{ $numberStudentPopulation->ebtedai }}"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" style="direction: rtl" id="motevasete_1" name="motevasete_1" value="{{ $numberStudentPopulation->motevasete_1 }}"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" style="direction: rtl" id="motevasete_2_ensani" name="motevasete_2_ensani" value="{{ $numberStudentPopulation->motevasete_2_ensani }}"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" style="direction: rtl" id="motevasete_2_math" name="motevasete_2_math" value="{{ $numberStudentPopulation->motevasete_2_math }}"
                                    class="form-control" placeholder="تعداد  را وارد کنید...">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" style="direction: rtl" id="motevasete_2_science" name="motevasete_2_science" value="{{ $numberStudentPopulation->motevasete_2_science }}"
                                    class="form-control" placeholder="تعداد  را وارد کنید...">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" style="direction: rtl" id="motevasete_2_kar_danesh" name="motevasete_2_kar_danesh" value="{{ $numberStudentPopulation->motevasete_2_kar_danesh }}"
                                    class="form-control" placeholder="تعداد  را وارد کنید...">
                            </div>
                        </div>
