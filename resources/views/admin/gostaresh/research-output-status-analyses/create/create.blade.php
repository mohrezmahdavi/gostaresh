        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST" action="{{ route('research-output-status-analyses.store') }}"
                        role="form">
                        @csrf
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="number_of_internal_inventions"
                                    name="number_of_internal_inventions" value="{{ old('number_of_internal_inventions') }}"
