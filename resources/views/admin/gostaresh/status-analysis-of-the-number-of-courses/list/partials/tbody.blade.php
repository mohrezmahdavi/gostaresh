...
@if (filterCol('number_of_international_Persian_language_courses_in_person') == true)
    <td>{{ $statusAnalysisOfTheNumberOfCourse?->number_of_international_Persian_language_courses_in_person }}
    </td>
@endif
@if (filterCol('number_of_international_virtual_Persian_language_courses') == true)
    <td>{{ $statusAnalysisOfTheNumberOfCourse?->number_of_international_virtual_Persian_language_courses }}
    </td>
@endif
@if (filterCol('number_of_international_courses_in_the_target_language_in_person') == true)
    <td>{{ $statusAnalysisOfTheNumberOfCourse?->number_of_international_courses_in_the_target_language_in_person }}
    </td>
@endif
@if (filterCol('number_of_international_courses_in_the_target_language_virtually') == true)
    <td>{{ $statusAnalysisOfTheNumberOfCourse?->number_of_international_courses_in_the_target_language_virtually }}
    </td>
@endif
