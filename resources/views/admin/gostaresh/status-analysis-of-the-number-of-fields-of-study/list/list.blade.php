                            ...
                            <tbody>
                                @foreach ($statusAnalysisOfTheNumberOfFieldsOfStudies as $key => $statusAnalysisOfTheNumberOfFieldsOfStudy)
                                    <tr>
                                        ...
                                        <td>{{ $statusAnalysisOfTheNumberOfFieldsOfStudy?->number_of_newly_established_courses }}</td>
                                        ...
                                        <td>{{ $statusAnalysisOfTheNumberOfFieldsOfStudy?->number_of_disciplines_corresponding_to_job_fields }}</td>
                                        <td>{{ $statusAnalysisOfTheNumberOfFieldsOfStudy?->number_of_fields_corresponding_to_the_specified_specialties }}</td>
                                        <td>{{ $statusAnalysisOfTheNumberOfFieldsOfStudy?->number_of_courses_offered_virtually }}</td>
                                        <td>{{ $statusAnalysisOfTheNumberOfFieldsOfStudy?->number_of_popular_fields_more_than_eighty_percent_capacity }}</td>
