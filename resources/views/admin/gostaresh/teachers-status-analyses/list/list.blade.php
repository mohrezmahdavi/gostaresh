...
@section('content')
                            ...
                            <tbody style="text-align: right; direction: ltr">
                                ...
                                <td>
                                    ...
                                    @can('delete-any-TeachersStatusAnalysis')
                                        <form method="POST"
                                            action="{{ route('teachers-status-analyses.destroy', $teachersStatusAnalysis) }}"
                                            role="form">
                                            @csrf
                                            {{ method_field('delete') }}
    ...
    <div class="row">
        <div class="col-md-12">
            <x-gostaresh.teachers-status-analysis.line-chart-by-all-fields-year-component></x-gostaresh.teachers-status-analysis.line-chart-by-all-fields-year-component>
        </div>
    </div>
@endsection
