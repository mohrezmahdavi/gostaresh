            ...
            <div class="card">
                <div class="card-body" id="app">
                    <form class="form-horizontal" method="POST"
                        ...
                        <x-select-year :default="$technologicalProduct->year" :required="false" name="year"></x-select-year>

                        <x-select-month :default="$technologicalProduct->month" :required="false" name="month"></x-select-month>
