...
@can("delete-any-UniversityCostsPerUnit")
 ...
 @endcan
    ...
    <div class="row">
        <div class="col-md-12">
            <x-gostaresh.university-costs-per-unit.line-chart-by-all-fields-year-component></x-gostaresh.university-costs-per-unit.line-chart-by-all-fields-year-component>
        </div>
    </div>
@endsection
